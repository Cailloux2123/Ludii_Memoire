...
/**
 * For Puzzle: A Unit Test to test the at Least ludeme.
 * 
 * @author Pierre.Accou
 */
...
public class AtLeastTest
{
	...
	{
		System.out.println(
				"\n=========================================\nAt Least Ludeme Deduction Puzzle Test\n=========================================\n");

		final long startAt = System.nanoTime();
		final File startFolder = new File("../Common/res/lud/puzzle/deduction/Test/AtLeast");
		...
		for (final File fileEntry : entries)
		{
			if (fileEntry.getName().contains(".lud"))
			{
				...
				final File trialsDir = new File("../Player/res/random_trials/puzzle/deduction/Test/AtLeast");
				...
				for (final File trialFile : trialFiles)
				{
					...
					IntConstant intconstante = new IntConstant(1);
					AtLeast atleast = new AtLeast(null, null, null, intconstante);
					
					if (trialFile.getName().contains("True")) {
						assert(atleast.eval(context) == true) : "The ludeme AtLeast will return true for this case but return false";
					}
					else {
						assert(atleast.eval(context) != true) : "The ludeme AtLeast will return false for this case but return true";
					}
