...
/**
 * For Puzzle: A Unit Test to test the is Match ludeme.
 * 
 * @author Pierre.Accou
 */
...
public class IsMatchTest
{
	...
	{
		System.out.println(
				"\n=========================================\nIs Match Ludeme Deduction Puzzle Test\n=========================================\n");

		final long startAt = System.nanoTime();
		final File startFolder = new File("../Common/res/lud/puzzle/deduction/Test/IsMatch");
		...
		for (final File fileEntry : entries)
		{
			if (fileEntry.getName().contains(".lud"))
			{
				...
				final File trialsDir = new File("../Player/res/random_trials/puzzle/deduction/Test/IsMatch");
				...
				for (final File trialFile : trialFiles)
				{
					...
					IsMatch isMatch = new IsMatch(null, null, null, null, intconstante);
					
					if (trialFile.getName().contains("True")) {
						assert(isMatch.eval(context) == true) : "The ludeme IsMatch will return true for this case but return false";
					}
					else {
						assert(isMatch.eval(context) != true) : "The ludeme IsMatch will return false for this case but return true";
					}
