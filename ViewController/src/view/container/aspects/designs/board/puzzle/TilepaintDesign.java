...
public class TilepaintDesign extends PuzzleDesign
{
	protected ArrayList<ArrayList<Location>> regionsLocalisation= new ArrayList<>();
	
	public TilepaintDesign(final BoardStyle boardStyle, final BoardPlacement boardPlacement) 
	{
	...
	public String createSVGImage(final Bridge bridge, final Context context)
	{
		...
		fillCells(g2d, boardStyle.placement().width, colorFillPhase0, colorEdgesInner, strokeThin, blackLocations, Color.LIGHT_GRAY, true);
