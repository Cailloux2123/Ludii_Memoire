...
public class Oscar extends AI
{
	...
	public void initAI(final Game game, final int playerID)
	{
		...
		// Run of the solver code.
	      try {
	    	String[] cmd = { "C:\\Program Files\\Git\\bin\\bash.exe", "-c", "/c/Users/eric.piette/runOscar.sh"};
			...
			System.out.println("Solved in calling external CSP Oscar in : " + f.format(secs));
