...
public interface ProblemAPI extends ProblemAPIOnVars, ProblemAPIOnVals, ProblemAPISymbolic {
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/intension">{@code intension}</a> from the specified argument that represents the
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/intension">{@code intension}</a>, while considering the operator {@code lt} applied
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/intension">{@code intension}</a>, while considering the operator {@code le} applied
	 * to the specified arguments. This is a modeling ease of use. As an illustration,
	 * 
	 * <pre>
	 * {@code lessEqual(x,y);}
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/intension">{@code intension}</a>, while considering the operator {@code ge} applied
	 * to the specified arguments. This is a modeling ease of use. As an illustration,
	 * 
	 * <pre>
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/intension">{@code intension}</a>, while considering the operator {@code gt} applied
	 * to the specified arguments. This is a modeling ease of use. As an illustration,
	 * 
	 * <pre>
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/intension">{@code intension}</a>, while considering the operator {@code eq} applied
	 * to the specified arguments. This is a modeling ease of use. As an illustration,
	 * 
	 * <pre>
	 * {@code equal(x,y);}
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/intension">{@code intension}</a>, while considering the operator {@code ne} applied
	 * to the specified arguments. This is a modeling ease of use. As an illustration,
	 * 
	 * <pre>
	 * {@code different(x,y);}
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/intension">{@code intension}</a>, while considering the operator {@code in} applied
	 * to the specified arguments. This is a modeling ease of use. As an illustration,
	 * 
	 * <pre>
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/intension">{@code intension}</a>, while considering the operator {@code imp}
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/intension">{@code intension}</a>, while considering the operator {@code iff}
	 * applied to the specified arguments. This is a modeling ease of use. As an illustration,
	 * 
	 * <pre>
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/intension">{@code intension}</a>, while considering the operator {@code add}
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/intension">{@code intension}</a>, while considering the operator {@code or} applied
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/extension">{@code extension}</a> from the specified syntactic tree (predicate). The
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/extension">{@code extension}</a> from the specified scope and the specified array
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/extension">{@code extension}</a> from the specified scope and the specified
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/extension">{@code extension}</a> from the specified scope and the specified table,
	...
	/**
	 * Builds a unary constraint <a href="http://org.xcsp.org/specifications/extension">{@code extension}</a> from the specified variable and the
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/regular">{@code regular}</a> from the specified scope and the specified automaton.
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/mdd">{@code mdd}</a> from the specified scope and the specified transitions. Note
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/allDifferent">{@code allDifferent}</a> on the specified integer variables: the
	...
	@Deprecated
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/allDifferent">{@code allDifferentExcept}</a> on the specified integer variables:
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/allDifferent">{@code allDifferentList}</a> on the specified lists of variables: all
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/allDifferent">{@code allDifferentMatrix}</a> on the specified matrix of variables.
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/allDifferent">{@code allDifferent}</a> on the specified syntactic trees
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/allDifferent">{@code allDifferent}</a> on the specified (stream of) syntactic trees
	 * (predicates): the predicates, when evaluated, must all take different values.
	 * 
	 * @param trees
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/allEqual">{@code allEqual}</a> on the specified integer variables: the variables
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/allEqual">{@code allEqualList}</a> on the specified lists of variables: all tuples
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/ordered">{@code ordered}</a> on the specified lists of variables: any two
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/ordered">{@code ordered}</a> on the specified lists of variables, while considering
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/ordered">{@code lex}</a> on the specified 2-dimensional array of variables: any two
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/ordered">{@code lex}</a> on the specified 2-dimensional array of variables, while
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/ordered">{@code lexMatrix}</a> on the specified matrix of variables. Any two
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/sum">{@code sum}</a> from the specified arguments: the weighted sum must respect
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/sum">{@code sum}</a> from the specified arguments: the sum must respect the
	 * specified condition.
	 *
	 * @param list
	 *            the summed variables
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/sum">{@code sum}</a> from the specified arguments: the (simple) sum must respect
	 * the condition expressed by the specified operator and the specified limit. As an illustration,
	 * 
	 * <pre>
	 * {@code sum(x,EQ,10);}
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/count">{@code count}</a> from the specified arguments: the number of variables in
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/nValues">{@code nValues}</a> from the specified arguments: the number of distinct
	...
	/**
	 * Builds a constraint <a href= "http://org.xcsp.org/specifications/nValues">{@code nValues}</a> from the specified arguments: at least two distinct
	...
	/**
	 * Builds a constraint <a href= "http://org.xcsp.org/specifications/cardinality">{@code cardinality}</a> from the specified arguments: when
	...
	/**
	 * Builds a constraint <a href= "http://org.xcsp.org/specifications/maximum">{@code maximum}</a> from the specified arguments: the maximum of the
	...
	/**
	 * Builds a constraint <a href= "http://org.xcsp.org/specifications/minimum">{@code minimum}</a> from the specified arguments: the minimum of the
	 * values assigned to the variables of {@code list} must respect the specified condition. Note that the array {@code list} is cleaned (i.e.,
	 * {@code null} values are discarded). <br>
	...
	/**
	 * Builds a constraint <a href= "http://org.xcsp.org/specifications/element">{@code element}</a> from the specified arguments: the specified value
	...
	/**
	 * Builds a constraint <a href= "http://org.xcsp.org/specifications/element">{@code element}</a> from the specified arguments: the value assigned to
	...
	/**
	 * Builds a constraint <a href= "http://org.xcsp.org/specifications/channel">{@code channel}</a> from the specified arguments: the value {@code j} is
	...
	/**
	 * Builds a constraint <a href= "http://org.xcsp.org/specifications/channel">{@code channel}</a> from the specified arguments: assuming for simplicity
	...
	/**
	 * Builds a constraint <a href= "http://org.xcsp.org/specifications/channel">{@code channel}</a> from the specified arguments: the value {@code i} is
	...
	/**
	 * Builds a constraint <a href= "http://org.xcsp.org/specifications/noOverlap">{@code noOverlap}</a> from the specified arguments: we are given a set
	...
	/**
	 * Builds a constraint <a href= "http://org.xcsp.org/specifications/noOverlap">{@code noOverlap}</a> from the specified arguments: we are given two
	...
	/**
	 * Builds a constraint <a href= "http://org.xcsp.org/specifications/cumulative">{@code cumulative}</a> from the specified arguments: we are given a
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/circuit">{@code circuit}</a> from the specified arguments.
	 * 
	 * @param list
	 *            an array of variables
	 * @param startIndex
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/circuit">{@code circuit}</a> on the specified array of variables. Note that 0 is
	 * the index used to refer to the first variable of the array.
	 * 
	 * @param list
	 *            an array of variables
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/circuit">{@code circuit}</a> from the specified arguments. Note that 0 is the index
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/instantiation">{@code instantiation}</a>, assigning each specified variable with
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/instantiation">{@code instantiation}</a>, assigning each specified variable at
	...
	/**
	 * Builds a meta-constraint <a href="http://org.xcsp.org/specifications/slide">{@code slide}</a> from the specified arguments. The specified template
	...
	/**
	 * Builds an <a href="http://org.xcsp.org/specifications/objectives">objective</a> (function) to minimize: the value of the specified variable.
	 * 
	 * @param x
	 *            a variable
	...
	/**
	 * Builds an <a href="http://org.xcsp.org/specifications/objectives">objective</a> (function) to maximize: the value of the specified variable.
	 * 
	 * @param x
	 *            a variable
	 * @return an object {@code ObjEntity} that wraps the built objective and allows us to provide note and tags by method chaining
	...
	/**
	 * Builds an <a href="http://org.xcsp.org/specifications/objectives">objective</a> (function) to minimize: the objective is defined by the specified
	...
	/**
	 * Builds an <a href="http://org.xcsp.org/specifications/objectives">objective</a> (function) to maximize: the objective is defined by the specified
	 * type on the specified array of variables. For example:
	 * 
	 * <pre>
