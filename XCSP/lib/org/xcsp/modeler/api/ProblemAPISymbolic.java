...
public interface ProblemAPISymbolic extends ProblemAPIOnVars, ProblemAPIOnVals {
	...
	/**
	 * Builds a symbolic constraint <a href="http://org.xcsp.org/specifications/extension">{@code extension}</a> from the specified scope and the
	...
	/**
	 * Builds a unary symbolic constraint <a href="http://org.xcsp.org/specifications/extension">{@code extension}</a> from the specified variable and the
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/allDifferent">{@code allDifferent}</a> on the specified symbolic variables: the
	...
	/**
	 * Builds a constraint <a href="http://org.xcsp.org/specifications/allEqual">{@code allEqual}</a> on the specified symbolic variables: the variables
